 ...
 *
 * Use the <[VIConversation update]> to send all changes at once.
 */
...
/**
 *  Array of conversation participants alongside with their rights.
 */
...
/**
 * Check if conversation is uber conversation.
 */
@property(nonatomic, assign, readonly) BOOL isUberConversation;
 ...
 *
 * @param participants Array of participants to be added to the conversation.
 */
 ...
 * Clients that are not connected will receive it later.
 *
 * @param participants Array of participants to be removed from conversation.
 */
