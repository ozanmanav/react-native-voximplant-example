...
/**
 * Triggered when conversation is created as the result of <[VIMessenger createConversation:moderators:title:distinct:enablePublicJoin:customData:uberConversation:]> method call.
 *
 * @param messenger Messenger instance.
