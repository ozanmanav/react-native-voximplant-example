...
typedef void (^RTCLoggingOverride)(RTCLoggingSeverity severity, NSString *logString);
...
RTC_EXTERN void RTCSetLoggingOverride(RTCLoggingOverride block, RTCLoggingSeverity severity);
